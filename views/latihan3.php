...
<body>
    <center><h3>Latihan Menampilkan data dari tabel user dan tampilkan 
        data user yang memiliki umur dari 21 sampai 30 tahun</h3></center>
    <center>
        ...
        <table border="1" ellspacing="0" cellpadding="5">
            ...
            <?php
            $no = 1;
            foreach ($user->tampil_data3() as $data) {
